...
/** @type {string} */
const CACHE_VERSION = '1752666835|3273233133';
/** @type {string} */
const CACHE_PREFIX = 'Tiltify Overlay-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'overlay.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["overlay.html","overlay.js","overlay.offline.html","overlay.icon.png","overlay.apple-touch-icon.png","overlay.audio.worklet.js","overlay.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["overlay.wasm","overlay.pck"];
